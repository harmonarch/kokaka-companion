...
| 设置昵称 | 已实现 |
| 注销账号 | 已实现 |
| 注销后清理 refresh token | 已实现 |
| 注销后清理短期聊天上下文 | 已实现 |
| WebSocket 聊天 | 已实现 |
| Agent 流式回复 | 已实现 |
| 最近对话上下文保存 | 已实现 |
| `normal`、`vulnerable`、`crisis`、`positive` 四类状态识别 | 已实现 |
| `vulnerable` 状态下避免说教和直接建议 | 已实现 |
| DeepSeek 回复生成 | 已实现 |
| DeepSeek 不可用时本地兜底回复 | 已实现 |
| Expo + React Native Web 原型 | 已实现 |
| 长期记忆系统 | 未实现 |
| 用户查看、编辑、删除记忆 | 未实现 |
| Vectorize 混合检索 | 未实现 |
| 主题聚类 | 未实现 |
